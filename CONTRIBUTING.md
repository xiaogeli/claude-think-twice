...
4. **The edit, in both places.** `.claude/skills/think-twice/SKILL.md` (the human-readable matrix) **and** `.claude/hooks/pre-push.sh` (the classifier). Keeping them in sync is the deal.
